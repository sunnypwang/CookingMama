var menuName = "Please select menu";
var names = ["-","-", "-", "-","-","-"];
var valTime = ["-",false,false,false,false,false];
var valTemp = ["-",false,false,false,false,false];
var time = ["-",0,0,0,0,0];
var temp = ["-",0,0,0,0,0];
var maxStep = 5;
...
function setValTime1(){
	valTime[1] = document.getElementById("timeCkBx1").checked;
}
function setValTemp1(){
	valTemp[1] = document.getElementById("tempCkBx1").checked;
}
function setTime1(){
...
function setValTime2(){
	valTime[2] = document.getElementById("timeCkBx2").checked;
}
function setValTemp2(){
	valTemp[2] = document.getElementById("tempCkBx2").checked;
}
function setTime2(){
...
function setValTime3(){
	valTime[3] = document.getElementById("timeCkBx3").checked;
}
function setValTemp3(){
	valTemp[3] = document.getElementById("tempCkBx3").checked;
}
function setTime3(){
...
function setValTime4(){
	valTime[4] = document.getElementById("timeCkBx4").checked;
}
function setValTemp4(){
	valTemp[4] = document.getElementById("tempCkBx4").checked;
}
function setTime4(){
...
function setValTime5(){
	valTime[5] = document.getElementById("timeCkBx5").checked;
}
function setValTemp5(){
	valTemp[5] = document.getElementById("tempCkBx5").checked;
}
function setTime5(){
